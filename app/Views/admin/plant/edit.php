...
<div class="container-fluid pb-4">
    ...
    <div class="edit-header">
        ...
        <div>
            <h1>Edit Plant</h1>
            <p>Update data plant baru untuk sistem</p>
        </div>
    </div>
    ...
    <div class="card form-card">
        ...
        <div class="card-body">
            <form action="<?= base_url('admin/plant/update/' . $plant->id) ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" name="nama_plant"
                            ...
                            value="<?= old('nama_plant', $plant->nama_plant) ?>"
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" name="kode_plant"
                            ...
                            value="<?= old('kode_plant', $plant->kode_plant) ?>"

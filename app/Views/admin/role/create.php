...
<div class="container-fluid">
    ...
    <div class="card form-card">
        <div class="card-header">
            <h5><i class="fas fa-plus-circle"></i> Informasi Role Baru</h5>
        </div>
        <div class="card-body">
            <form method="POST" action="/admin/roles/store" novalidate>
                <?= csrf_field() ?>
                ...
                <div class="form-group">
                    ...
                    <textarea id="description"
                        ...
                        rows="3"
                        placeholder="Jelaskan tujuan dan tanggung jawab role ini"><?= old('description') ?></textarea>
                </div>

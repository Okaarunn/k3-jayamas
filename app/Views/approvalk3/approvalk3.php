        ...
        <div class="mb-3 mb-md-0">
            <h1 class="mb-1">
                ...
                <span class="d-block d-md-inline">
                    Persetujuan Work Permit — Tim K3
                </span>
            </h1>
            <p class="mb-0">
                Tinjau dan berikan keputusan atas setiap pengajuan izin kerja yang masuk
            </p>
        </div>
    </div>
    ...
    $(document).ready(function() {
        ...
        $(document).ready(function() {
            $('#accModal').on('show.bs.modal', function(e) {
                ...
                var actionUrl = "<?= base_url('approval-k3/approve') ?>/" + id;
        ...
        $(document).ready(function() {
            $('#rejectModal').on('show.bs.modal', function(e) {
                ...
                $('#rejectForm').attr('action', '<?= base_url('approval-k3/reject') ?>/' + id);
            });
        });
        ...
        $(document).ready(function() {
            $('#deleteModal').on('show.bs.modal', function(e) {
                ...
                $('#deleteForm').attr('action', '<?= base_url("approval-k3/delete") ?>/' + id);
            });
        });
